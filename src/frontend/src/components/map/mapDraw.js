...
export function parseColor(hint, fallback) {
    if (!hint)
        return fallback;
    const s = hint.trim();
...
// 静态层：bbox 边界 + 网格 + 比例尺
// ============================================================
export function drawStaticLayer(layer, map) {
...
// 要素层：按 shape 绘制单个要素
// ============================================================
export function drawFeature(feature) {
...
// ============================================================
export function drawHeatmapLayer(layer, heatmaps, mapBbox) {
    layer.removeChildren();
